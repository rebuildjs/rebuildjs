...
test.only("browser__metafile", async () => {
  const file_exists__path = void 0;
  let readFile_path = void 0;
  let _browser__metafile$_;
  let _browser__metafile_;
  let _browser__metafile__set;
  is_prod__set(app_ctx, true);
  ...
  equal(_browser__metafile$_(app_ctx)._, void 0);
  equal(_browser__metafile_(app_ctx), void 0);
  await rmemo__wait(
...
test("browser__output__relative_path", () => {
  ...
  equal(browser__output__relative_path$_(middleware_ctx)._, void 0);
  equal(browser__output__relative_path_(middleware_ctx), void 0);
...
test("browser__script", () => {
  const middleware_ctx = middleware_ctx_();
  equal(browser__script$_(middleware_ctx)._, void 0);
  equal(browser__script_(middleware_ctx), void 0);
  server__metafile__set(middleware_ctx, server_metafile0);
  equal(browser__script$_(middleware_ctx)._, void 0);
  equal(browser__script_(middleware_ctx), void 0);
  browser__metafile__set(middleware_ctx, browser_metafile0);
